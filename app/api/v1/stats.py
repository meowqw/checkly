...
@router.get(
    ...
    description=(
        "Суммы доходов и расходов, разбивка расходов по **категориям** и по **тегам** "
        "(для чеков — по позициям) и последние 8 расходов.\n\n"
        "Поле `tags`: позиция с несколькими тегами учитывает полную сумму в каждом; "
        "позиции/tx без тегов — bucket «Без тега».\n\n"
