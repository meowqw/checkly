...
_KEYWORD_HINTS: dict[str, list[tuple[str, str]]] = {
    "Продукты": [
        ...
        ("Снэки", (
            "чипс", "снек", "snack", "попкорн", "орех", "орешк", "сухар", "крекер",
            "сухарик", "гренк", "семеч", "фисташ", "миндал", "кешью", "нутс",
        )),
        ("Никотин", (
            "сигар", "табак", "никотин", "стик", "iqos", "айкос", "glo", "вейп",
            "vape", "эсдн", "снюс", "насвай", "кальян",
        )),
    ],
    "Животные": [
        ("Животные", (
            "корм", "наполнит", "лоток", "ошейник", "поводок", "ветерин",
            "когтеточ", "аквариум", "террариум", "pet ", "pets",
        )),
    ],
    "Здоровье": [
